...
public class checkWN : MonoBehaviour
{
    public static checkWN instance;
    ...
    private void LateUpdate()
    {
        ...
        {
            Vector3 desiredPosition = new Vector3(target.position.x+1.8f, target.position.y, target.position.z + 2.2f);
    ...
    {
        if (other.CompareTag("Player") && PlayerCTR.instance.groundedPlayer)
        { 
            isWinner = true;
        }
    }
